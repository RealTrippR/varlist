...
the .varlist specification is straightforward line-oriented data format similar to .env. All variables are key-value pairs and is either implicitly typed based on its literal form or explicitly typed via a type specifier.
